                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <Card className="p-4">
                        ...
                        <div className="relative">
                            ...
                            <div className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-text-secondary">Γû╝</div>
                        </div>
                    </Card>
                    ...
                    >
                        ...
                        {unassignedSlots.length > 0 && (
                            <div className="text-xs text-red-500/70 mt-1">Klik untuk lihat detail ΓåÆ</div>
                        )}
                    </button>
                </div>
                    ...
                    <div className="fixed inset-0 bg-background-dark/80 backdrop-blur-sm flex items-center justify-center z-[60] p-4">
                        <div className="bg-white dark:bg-surface-dark border border-secondary/20 dark:border-white/5 rounded-3xl p-6 w-full max-w-2xl max-h-[80vh] overflow-hidden flex flex-col shadow-2xl">
                            <div className="flex items-center justify-between mb-4">
                                <div>
                                    <h2 className="text-xl font-bold text-text-main dark:text-white">≡ƒÜ¿ Kelas Belum Ada Guru</h2>
                                            ...
                                            >
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="text-sm text-text-secondary dark:text-zinc-400">
                                                        {hasAssignments ? (
                                                            <span>
                                                                {group.subjects.length} mapel ΓÇó {group.total_classes} kelas
                                                            </span>
                                                        ) : (
                                                            <span className="text-amber-600 dark:text-amber-400">
                                                                ΓÜá∩╕Å Belum ada penugasan
                                                            </span>
                                                        )}
                                                    </div>
                                                </div>
                                            ...
                                            <div className="md:col-span-4 flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="text-xs text-text-secondary">
                                                        {cls.school_level || '-'} ΓÇó Tingkat {cls.grade_level || '-'}
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="md:col-span-5">
                                                {isLocked ? (
                                                    ...
                                                    <div className="relative">
                                                        ...
                                                        >
                                                            <option value="">ΓÇö Belum ada wali kelas ΓÇö</option>
                                                            {teachers
